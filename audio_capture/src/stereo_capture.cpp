  ...
  class RosGstCapture
  {
    public:
      RosGstCapture()
      {
        ...
        ros::param::param<std::string>("~output_channel_tn", _output_channel_tn, "left");

        // The source of the audio
        std::string device;
        ros::param::param<std::string>("~device", device, "");

        _pub = _nh.advertise<audio_common_msgs::AudioData>(_output_channel_tn, 10, true);
    ...
    private:
      ...
      GMainLoop *_loop;
      std::string _format, _sample_format, _output_channel_tn;
  };
}
